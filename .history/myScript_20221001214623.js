function getClients(){
    ...
    $.ajax({
        ...
        success: function(clients){
            ...
            $('#clientsList').empty();
            $('#clientsList').append("<thead><tr><th scope='col'>Id</th><th scope='col'>Name</th><th scope='col'>Email</th><th scope='col'>Age</th></tr></thead><tbody></tbody>");
            for(i = 0; i<cs.length; i++){
                ...
                $('#clientsList').append("<tr><th scope='row'>"+cs[i].id+"</th><td>"+cs[i].name+"</td><td>"+cs[i].email+"</td><td>"+cs[i].age+"</td></tr>");
