    ...
    $.ajax({
        ...
        success: function(cinemas){
            ...
            for(i = 0; i<cs.length; i++){
                ...
                $('#clientsList').append("<tr><th scope='row'>"+cs[i].id+"</th><td>"+cs[i].owner+"</td><td>"+cs[i].capacity+"</td><td>"+cs[i].category_id+"</td><td>"+"<button class='btn btn-danger' onclick='deleteCinema("+cs[i].id+")'>DELETE</button></td></tr>");
