...
function setCinema(){
    ...
    //     url: 'http://150.136.80.156:80/api/Category/all',
    //     //data: myData,
    //     type: 'GET',
    //     crossDomain: true,
    //     dataType: 'jsonp',
    ...
    //     beforeSend: {'Access-Control-Allow-Origin': '*'}
...
axios({
    method: 'get',
    url: 'https://150.136.80.156:80/api/Category/all',headers: {
        'Content-Type': 'multipart/form-data', 'Access-Control-Allow-Origin': 'https://150.136.80.156:80/api/', 
    ...
    // var settings = {
    //     "url": "http://150.136.80.156:80/api/Cinema/all",
    //     "method": "GET",
    //     "timeout": 0,
    //     "headers": {
    ...
    // }
    // xmlHttp.open("GET", 'http://150.136.80.156:80/api/Cinema/all', true); // true for asynchronous 
    // xmlHttp.send(null);
