...
console.log(item);
    let id = $("#cinemaIdEdit").val(item.id);
    let owner = $("#cinemaOwnerEdit").val(item.owner);
    let capacity = $("#cinemaCapacityEdit").val(item.capacity);
    let category = $("#cinemaCategoryEdit").val(item.category_id);
    let name = $("#cinemaNameEdit").val(item.name);
